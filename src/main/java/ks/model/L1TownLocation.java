...
public class L1TownLocation {
    ...
    public static final int TOWNID_SILVERIA_VILLAGE = 18;

    public static final int TOWNID_BEHIMOS_VILLAGE = 19;

    public static final int TOWNID_FEATHER_VILLAGE = 20;
    ...
    private static final Point[] GETBACK_LOC_GLUDIO = {
            ...
            new Point(32611, 32722), new Point(32612, 32781),
    ...
    private static final Point[] GETBACK_LOC_ORCISH_FOREST = {
            new Point(32750, 32435),
            new Point(32745, 32447),
            new Point(32738, 32452),
            new Point(32741, 32436),
    ...
    private static final short GETBACK_MAP_SILVERIA_VILLAGE = 1000;

    private static final Point[] GETBACK_LOC_SILVERIA_VILLAGE = {
            new Point(32805, 32871), new Point(32790, 32868),
            new Point(32800, 32854), new Point(32813, 32857),
            new Point(32802, 32849), new Point(32813, 32875)};

    private static final short GETBACK_MAP_BEHIMOS_VILLAGE = 1001;

    private static final Point[] GETBACK_LOC_BEHIMOS_VILLAGE = {
            new Point(32811, 32854), new Point(32804, 32843),
            new Point(32820, 32858), new Point(32795, 32855),
            new Point(32796, 32882), new Point(32803, 32871)};

    private static final short GETBACK_MAP_FEATHER_VILLAGE = 621;

    private static final Point[] GETBACK_LOC_FEATHER_VILLAGE = {
            new Point(32770, 32872), new Point(32776, 32874),
            new Point(32726, 32864), new Point(32724, 32860),
            new Point(32786, 32878), new Point(32785, 32865),
            new Point(32777, 32861), new Point(32740, 32857),
            new Point(32736, 32864), new Point(32734, 32876),
            new Point(32751, 32860)};
    ...
    public static int[] getGetBackLoc(int town_id) {
        ...
        switch (town_id) {
            case TOWNID_TALKING_ISLAND: {
                int rnd = RandomUtils.nextInt(GETBACK_LOC_TALKING_ISLAND.length);
            ...
            break;
            case TOWNID_KENT: {
                int rnd = RandomUtils.nextInt(GETBACK_LOC_KENT.length);
            ...
            break;
            case TOWNID_GLUDIO: {
                int rnd = RandomUtils.nextInt(GETBACK_LOC_GLUDIO.length);
            ...
            case TOWNID_ORCISH_FOREST: { // 오크마을
                int rnd = RandomUtils.nextInt(GETBACK_LOC_ORCISH_FOREST.length);
            ...
            case TOWNID_WINDAWOOD: { // 윈다우드
                int rnd = RandomUtils.nextInt(GETBACK_LOC_WINDAWOOD.length);
            ...
            case TOWNID_GIRAN: { // 기란
                int rnd = RandomUtils.nextInt(GETBACK_LOC_GIRAN.length);
            ...
            case TOWNID_HEINE: { // 하이네
                int rnd = RandomUtils.nextInt(GETBACK_LOC_HEINE.length);
            ...
            case TOWNID_WERLDAN: { // 웰던
                int rnd = RandomUtils.nextInt(GETBACK_LOC_WERLDAN.length);
            ...
            break;
            case TOWNID_OREN: { // 오렌
                int rnd = RandomUtils.nextInt(GETBACK_LOC_OREN.length);
            ...
            case TOWNID_ELVEN_FOREST: { // 요정숲
                int rnd = RandomUtils.nextInt(GETBACK_LOC_ELVEN_FOREST.length);
            ...
            break;
            case TOWNID_ADEN: { // 아덴
                int rnd = RandomUtils.nextInt(GETBACK_LOC_ADEN.length);
            ...
            case TOWNID_SILENT_CAVERN: { // 은기사
                int rnd = RandomUtils.nextInt(GETBACK_LOC_SILENT_CAVERN.length);
            ...
            case TOWNID_OUM_DUNGEON: { // 오움던전
                int rnd = RandomUtils.nextInt(GETBACK_LOC_OUM_DUNGEON.length);
            ...
            case TOWNID_RESISTANCE: { // 몰라
                int rnd = RandomUtils.nextInt(GETBACK_LOC_RESISTANCE.length);
            ...
            case TOWNID_PIRATE_ISLAND: { // 몰라
                int rnd = RandomUtils.nextInt(GETBACK_LOC_PIRATE_ISLAND.length);
            ...
            break;
            default: { // 은기사
                int rnd = RandomUtils.nextInt(GETBACK_LOC_SILVER_KNIGHT_TOWN.length);
