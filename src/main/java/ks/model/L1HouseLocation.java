...
public class L1HouseLocation {
    ...
    private static final List<Integer> houseIds = HouseTable.getHouseIdList();
    ...
    public static boolean isRegenLoc(L1PcInstance pc, int locx, int locy,
        ...
        // 엄마나무
        if ((ls >= 65374 && ls <= 65408) && (lm >= -734 && lm <= -701) && mapid == 4 && pc.isElf()) {
            ret = true;
        } else if ((ls >= 65645 && ls <= 65665) && (lm >= 77 && lm <= 97) && mapid == 621) {
            ret = true;
        } else if (ls >= 65584 && ls <= 65604 && lm >= 50 && lm <= 70 && mapid == 622) {
            ret = true;
        } else if ((ls >= 65649 && ls <= 65679) && (lm >= 47 && lm <= 76) && mapid == 1001 && pc.isIllusionist()) {
            ret = true;
        } else if ((ls >= 65649 && ls <= 65679) && (lm >= 49 && lm <= 78) && mapid == 1001 && pc.isDragonKnight()) {
            ret = true;
        }
    ...
    public static boolean isInHouseLoc(int houseId, int locx, int locy, short mapid) {
        ...
        switch (houseId) {
            ...
            case 327687:
                ...
                break;
            case 327688:
                if (locx >= 33577 && locx <= 33578 && locy == 33337 && mapid == 4 || locx >= 33579
            ...
            case 327690:
                ...
                break;
            case 327691:
                if (locx >= 33621 && locx <= 33622 && locy == 33444 && mapid == 4 || locx >= 33622
            ...
            case 524290:
                if (locx >= 32548 && locx <= 32556 && locy >= 32705
                        && locy <= 32716 && mapid == 4 || locx == 32547 && locy >= 32710 && locy <= 32716
                        && mapid == 4) {
                    ret = true;
                }
                break;
            ...
            case 524292:
                ...
                break;
            case 524293:
                if (locx >= 32535 && locx <= 32543 && locy >= 32807 && locy <= 32818 && mapid == 4 || locx == 32534 && locy >= 32812 && locy <= 32818 && mapid == 4) {
                    ret = true;
                }
                break;
            case 524294:
