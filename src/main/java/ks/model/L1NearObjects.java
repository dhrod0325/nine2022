...
public class L1NearObjects {
    public List<L1Object> knownObjects = new CopyOnWriteArrayList<>();
    public List<L1PcInstance> knownPlayer = new CopyOnWriteArrayList<>();
    public List<L1MonsterInstance> knownMonster = new CopyOnWriteArrayList<>();
