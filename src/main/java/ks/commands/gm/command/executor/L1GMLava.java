...
import ks.packets.serverpackets.S_GMLava;
...
public class L1GMLava implements L1CommandExecutor {
    ...
    private static final Logger _log = LogManager.getLogger(S_GMLava.class.getName());
    ...
    public void execute(L1PcInstance pc, String cmdName, String arg) {
        try {
            ...
            if (i > 0 && i < 36) {
                pc.sendPackets(new S_SystemMessage("운영자 라던(" + i + ")맵으로 이동 했습니다."));
            }
